...
date: 2023-03-08T08:06:25+06:00
description: "Binary search with basic geometry"
menu:
  sidebar:
    name: 1137
    identifier: 1137
...
![Diagram here](images/diagram.png)
...
<img src="https://latex.codecogs.com/gif.latex?r=&space;\frac{D}{2}" title="r= \frac{D}{2}" />
  ...
  <img src="https://latex.codecogs.com/gif.latex?=\frac{h}{2}&plus;\frac{a^{2}}{2h}" title="=\frac{h}{2}+\frac{a^{2}}{2h}" />
